...
const PrescriptionAnalyzer = ({ token, onOpenAuth }) => {
  ...
  return (
    <div style={{ maxWidth: '850px', margin: '40px auto', padding: '0 24px', display: 'flex', flexDirection: 'column', gap: '30px' }}>
      
      {/* Header Banner */}
      <section style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        <h2 style={{ fontSize: '2rem', color: '#fff', fontWeight: 800, fontFamily: 'Outfit' }}>
